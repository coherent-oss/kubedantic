...
class VolumeError(BaseModel):
    ...
    time: Optional[datetime] = Field(
        default=None, description="time represents the time the error was encountered."
    )
...
class CSIDriverSpec(BaseModel):
    ...
    fsGroupPolicy: Optional[str] = Field(
        ...
        description=(
            ...
            " FSGroupPolicy values for additional details.\n\nThis field was immutable"
            " in Kubernetes < 1.29 and now is mutable.\n\nDefaults to"
            " ReadWriteOnceWithFSType, which will examine each volume to determine if"
            " Kubernetes should modify ownership and permissions of the volume. With"
            " the default policy the defined fsGroup will only be applied if a fstype"
...
class CSIStorageCapacity(BaseModel):
    ...
    capacity: Optional[Union[str, float]] = Field(
        default=None,
        description=(
    ...
    maximumVolumeSize: Optional[Union[str, float]] = Field(
        default=None,
        description=(
...
class StorageClass(BaseModel):
    ...
    volumeBindingMode: Optional[VolumeBindingMode] = Field(
        default=None,
        description=(
            ...
            " PersistentVolumeClaims should be immediately provisioned and bound. This"
            ' is the default mode.\n - `"WaitForFirstConsumer"` indicates that'
            " PersistentVolumeClaims should not be provisioned and bound until the"
            " first Pod is created that references the PeristentVolumeClaim. The volume"
            " provisioning and binding will occur during Pod scheduing."
        ),
    )
