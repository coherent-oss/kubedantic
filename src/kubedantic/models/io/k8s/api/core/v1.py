...
class AppArmorProfile(BaseModel):
    ...
    type: Type = Field(
        ...
        description=(
            ...
            " indicates that a profile pre-loaded on the node should be used.\n -"
            ' `"RuntimeDefault"` indicates that the container runtime\'s default'
            ' AppArmor profile should be used.\n - `"Unconfined"` indicates that no'
            " AppArmor profile should be enforced."
        ),
    )
...
class ModifyVolumeStatus(BaseModel):
    status: Status = Field(
        ...
        description=(
            ...
            " indicates that the request has been rejected as invalid by the CSI"
            " driver. To resolve the error, a valid VolumeAttributesClass needs to be"
            ' specified\n - `"Pending"` Pending indicates that the'
            " PersistentVolumeClaim cannot be modified due to unmet requirements, such"
...
class NodeConfigSource(BaseModel):
    configMap: Optional[ConfigMapNodeConfigSource] = Field(
        default=None, description="ConfigMap is a reference to a Node's ConfigMap"
    )
...
class NodeDaemonEndpoints(BaseModel):
    kubeletEndpoint: Optional[DaemonEndpoint] = Field(
        default=None, description="Endpoint on which Kubelet is listening."
    )


class NodeRuntimeHandlerFeatures(BaseModel):
    recursiveReadOnlyMounts: Optional[bool] = Field(
        default=None,
        description=(
...
class AllocatedResourceStatuses(Enum):
...
class ScopedResourceSelectorRequirement(BaseModel):
    ...
    scopeName: ScopeName = Field(
        ...
        description=(
            ...
            ' values:\n - `"BestEffort"` Match all pod objects that have best effort'
            ' quality of service\n - `"CrossNamespacePodAffinity"` Match all pod'
            " objects that have cross-namespace pod (anti)affinity mentioned.\n -"
            ' `"NotBestEffort"` Match all pod objects that do not have best effort'
            ' quality of service\n - `"NotTerminating"` Match all pod objects where'
            ' spec.activeDeadlineSeconds is nil\n - `"PriorityClass"` Match all pod'
            ' objects that have priority class mentioned\n - `"Terminating"` Match all'
            " pod objects where spec.activeDeadlineSeconds >=0"
        ),
    )
    values: Optional[List[str]] = Field(
        default=None,
...
class InternalTrafficPolicy(Enum):
    Cluster = "Cluster"
    Local = "Local"
...
class VolumeMount(BaseModel):
    ...
    mountPropagation: Optional[MountPropagation] = Field(
        ...
        description=(
            ...
            " means that the volume in a container will receive new mounts from the"
            " host or other containers, and its own mounts will be propagated from the"
            " container to the host or other containers. Note that this mode is"
            ' recursively applied to all mounts in the volume ("rshared" in Linux'
...
class VolumeMountStatus(BaseModel):
    ...
    readOnly: Optional[bool] = Field(
        default=None, description="ReadOnly corresponds to the original VolumeMount."
    )
    recursiveReadOnly: Optional[str] = Field(
        default=None,
        description=(
            "RecursiveReadOnly must be set to Disabled, Enabled, or unspecified (for"
            " non-readonly mounts). An IfPossible value in the original VolumeMount"
            " must be translated to Disabled or Enabled, depending on the mount result."
        ),
    )
...
class TopologySelectorTerm(BaseModel):
    matchLabelExpressions: Optional[List[TopologySelectorLabelRequirement]] = Field(
        default=None, description="A list of topology selector requirements by labels."
    )
...
class CSIPersistentVolumeSource(BaseModel):
    ...
    volumeAttributes: Optional[Dict[str, str]] = Field(
        default=None, description="volumeAttributes of the volume to publish."
    )
...
class ContainerStateRunning(BaseModel):
    startedAt: Optional[datetime] = Field(
        default=None, description="Time at which the container was last (re-)started"
    )
...
class ContainerStateTerminated(BaseModel):
    ...
    finishedAt: Optional[datetime] = Field(
        default=None, description="Time at which the container last terminated"
    )
    message: Optional[str] = Field(
        default=None,
...
class EndpointAddress(BaseModel):
    ...
    targetRef: Optional[ObjectReference] = Field(
        default=None, description="Reference to object providing the endpoint."
    )
...
class EventSeries(BaseModel):
    ...
    lastObservedTime: Optional[datetime] = Field(
...
class LimitRangeItem(BaseModel):
    ...
    defaultRequest: Optional[Dict[str, Union[str, float]]] = Field(
        default=None,
        description=(
    ...
    maxLimitRequestRatio: Optional[Dict[str, Union[str, float]]] = Field(
        default=None,
        description=(
...
class NamespaceStatus(BaseModel):
    ...
    phase: Optional[Phase] = Field(
        ...
        description=(
            ...
            " https://kubernetes.io/docs/tasks/administer-cluster/namespaces/\n\nPossible"
            ' enum values:\n - `"Active"` means the namespace is available for use in'
...
class NodeCondition(BaseModel):
    lastHeartbeatTime: Optional[datetime] = Field(
        default=None, description="Last time we got an update on a given condition."
    )
    lastTransitionTime: Optional[datetime] = Field(
        default=None,
...
class NodeStatus(BaseModel):
    ...
    daemonEndpoints: Optional[NodeDaemonEndpoints] = Field(
        default=None, description="Endpoints of daemons running on the Node."
    )
    ...
    runtimeHandlers: Optional[List[NodeRuntimeHandler]] = Field(
        default=None, description="The available runtime handlers."
    )
    volumesAttached: Optional[List[AttachedVolume]] = Field(
        default=None, description="List of volumes that are attached to the node."
    )
...
class PersistentVolumeClaimStatus(BaseModel):
    ...
    allocatedResourceStatuses: Optional[Dict[str, AllocatedResourceStatuses]] = Field(
        default=None,
        description=(
...
class PersistentVolumeStatus(BaseModel):
    lastPhaseTransitionTime: Optional[datetime] = Field(
        default=None,
        description=(
            ...
            " transitions. This is a beta field and requires the"
            " PersistentVolumeLastPhaseTransitionTime feature to be enabled (enabled by"
            " default)."
        ),
    )
    message: Optional[str] = Field(
    ...
    phase: Optional[PhaseModel2] = Field(
        ...
        description=(
            ...
            ' enum values:\n - `"Available"` used for PersistentVolumes that are not'
            " yet bound Available volumes are held by the binder and matched to"
            ' PersistentVolumeClaims\n - `"Bound"` used for PersistentVolumes that are'
            ' bound\n - `"Failed"` used for PersistentVolumes that failed to be'
            " correctly recycled or deleted after being released from a claim\n -"
            ' `"Pending"` used for PersistentVolumes that are not available\n -'
            ' `"Released"` used for PersistentVolumes where the bound'
            " PersistentVolumeClaim was deleted released volumes must be recycled"
            " before becoming available again this phase is used by the persistent"
            " volume claim binder to signal to another process to reclaim the resource"
        ),
    )
    reason: Optional[str] = Field(
        default=None,
...
class PodCondition(BaseModel):
    lastProbeTime: Optional[datetime] = Field(
        default=None, description="Last time we probed the condition."
    )
    lastTransitionTime: Optional[datetime] = Field(
        default=None,
...
class ServicePort(BaseModel):
    ...
    targetPort: Optional[Union[int, str]] = Field(
        default=None,
        description=(
...
class ServiceSpec(BaseModel):
    ...
    externalTrafficPolicy: Optional[ExternalTrafficPolicy] = Field(
        ...
        description=(
            ...
            ' picking a node.\n\nPossible enum values:\n - `"Cluster"` routes traffic'
            ' to all endpoints.\n - `"Local"` preserves the source IP of the traffic by'
    ...
    internalTrafficPolicy: Optional[InternalTrafficPolicy] = Field(
        default=None,
        description=(
            ...
            ' features).\n\nPossible enum values:\n - `"Cluster"` routes traffic to all'
            ' endpoints.\n - `"Local"` routes traffic only to endpoints on the same'
            " node as the client pod (dropping the traffic if there are no local"
            " endpoints)."
        ),
    )
    ipFamilies: Optional[List[IpFamily]] = Field(
        default=None,
        description=(
    ...
    ipFamilyPolicy: Optional[IpFamilyPolicy] = Field(
        default=None,
        description=(
            ...
            ' ExternalName.\n\nPossible enum values:\n - `"PreferDualStack"` indicates'
            " that this service prefers dual-stack when the cluster is configured for"
            " dual-stack. If the cluster is not configured for dual-stack the service"
            " will be assigned a single IPFamily. If the IPFamily is not set in"
            " service.spec.ipFamilies then the service will be assigned the default"
            ' IPFamily configured on the cluster\n - `"RequireDualStack"` indicates'
            " that this service requires dual-stack. Using"
            " IPFamilyPolicyRequireDualStack on a single stack cluster will result in"
            " validation errors. The IPFamilies (and their order) assigned to this"
            " service is based on service.spec.ipFamilies. If service.spec.ipFamilies"
            " was not provided then it will be assigned according to how they are"
            " configured on the cluster. If service.spec.ipFamilies has only one entry"
            " then the alternative IPFamily will be added by apiserver\n -"
            ' `"SingleStack"` indicates that this service is required to have a single'
            " IPFamily. The IPFamily assigned is based on the default IPFamily used by"
            " the cluster or as identified by service.spec.ipFamilies field"
        ),
    )
    ...
    trafficDistribution: Optional[str] = Field(
        default=None,
        description=(
            "TrafficDistribution offers a way to express preferences for how traffic is"
            " distributed to Service endpoints. Implementations can use this field as a"
            " hint, but are not required to guarantee strict adherence. If the field is"
            " not set, the implementation will apply its default routing strategy. If"
            ' set to "PreferClose", implementations should prioritize endpoints that'
            " are topologically close (e.g., same zone)."
        ),
    )
    type: Optional[TypeModel2] = Field(
        ...
        description=(
            ...
            ' enum values:\n - `"ClusterIP"` means a service will only be accessible'
            ' inside the cluster, via the cluster IP.\n - `"ExternalName"` means a'
            " service consists of only a reference to an external name that kubedns or"
            " equivalent will return as a CNAME record, with no exposing or proxying of"
            ' any pods involved.\n - `"LoadBalancer"` means a service will be exposed'
            " via an external load balancer (if the cloud provider supports it), in"
            " addition to 'NodePort' type.\n - `\"NodePort\"` means a service will be"
            " exposed on one port of every node, in addition to 'ClusterIP' type."
        ),
    )
...
class Taint(BaseModel):
    effect: Effect = Field(
        ...
        description=(
            ...
            ' enum values:\n - `"NoExecute"` Evict any already-running pods that do not'
            " tolerate the taint. Currently enforced by NodeController.\n -"
...
class ContainerStatus(BaseModel):
    ...
    volumeMounts: Optional[List[VolumeMountStatus]] = Field(
        default=None, description="Status of volume mounts."
    )
...
class Event(BaseModel):
    ...
    lastTimestamp: Optional[datetime] = Field(
        default=None,
        description=(
    ...
    reportingInstance: Optional[str] = Field(
        default="", description="ID of the controller instance, e.g. `kubelet-xyzf`."
    )
...
class PersistentVolumeSpec(BaseModel):
    ...
    persistentVolumeReclaimPolicy: Optional[PersistentVolumeReclaimPolicy] = Field(
        ...
        description=(
            ...
            ' enum values:\n - `"Delete"` means the volume will be deleted from'
            " Kubernetes on release from its claim. The volume plugin must support"
            ' Deletion.\n - `"Recycle"` means the volume will be recycled back into the'
            " pool of unbound persistent volumes on release from its claim. The volume"
            ' plugin must support Recycling.\n - `"Retain"` means the volume will be'
            " left in its current phase (Released) for manual reclamation by the"
    ...
    volumeMode: Optional[VolumeMode] = Field(
        ...
        description=(
            ...
            ' a raw block device.\n - `"Filesystem"` means the volume will be or is'
...
class PodStatus(BaseModel):
    ...
    phase: Optional[PhaseModel3] = Field(
        ...
        description=(
            ...
            ' enum values:\n - `"Failed"` means that all containers in the pod have'
            " terminated, and at least one container has terminated in a failure"
            ...
            ' host.\n - `"Running"` means the pod has been bound to a node and all of'
            " the containers have been started. At least one container is still running"
            ' or is in the process of being restarted.\n - `"Succeeded"` means that all'
            ...
            ' containers.\n - `"Unknown"` means that for some reason the state of the'
            " pod could not be obtained, typically due to an error in communicating"
            " with the host of the pod. Deprecated: It isn't being set since 2015"
    ...
    resourceClaimStatuses: Optional[List[PodResourceClaimStatus]] = Field(
        default=None, description="Status of resource claims."
    )
